...
我目前是海南大学计算机科学与技术学院副研究员。博士毕业于厦门大学 MAC 实验室，师从 [纪荣嵘教授](https://scholar.google.com/citations?user=lLx2CGcAAAAJ)。硕士毕业于北京大学，本科毕业于北京理工大学。

我正在积极招募对 AI 研究有热情的海南大学本科生加入课题组，也欢迎有意向的同学报考我的硕士生。如果你对高效深度学习、模型压缩或相关方向感兴趣，欢迎联系我。

我已发表约 20 篇 CCF-A/B 类顶级会议和期刊论文，其中一作或通讯作者 10 余篇。我的研究方向是让前沿 AI 模型真正落地到实际应用中，涵盖**后训练量化**、**网络剪枝**和**高效架构设计**。

## 🔬 研究方向

- **模型量化** — 后训练量化 (PTQ)、无数据量化、任意比特量化
- **高效视觉 Transformer** — ViT 压缩、ViT 后训练量化
- **生成式模型加速** — 扩散模型加速、高效推理
- **图像复原** — 超分辨率、摩尔纹去除、阴影去除
...
完整列表见 [Publications](/publications/) 页面和 [Google Scholar](https://scholar.google.com/citations?user=g1-HBJAAAAAJ&hl=zh-CN)。`†` 表示通讯作者。
...
📧 欢迎联系: [yszhong01@gmail.com](mailto:yszhong01@gmail.com) | [GitHub](https://github.com/zysxmu)
